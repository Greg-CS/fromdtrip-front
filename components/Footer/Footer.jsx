  ...
  return (
    <AnimatePresence>
      <motion.footer
        ...
        id="footer"
        className={`items-center justify-around p-10 bg-[#07100B] footer text-[#71948D]
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-24">
          <div className="grid gap-10">
            <div className="h-12">
              <span className="text-[20px] font-extrabold">Help</span>
            </div>
            <div className="grid gap-5">
              <a href="#my_modal_7" className="">
                Size guide
              </a>
              {/* Put this part before </body> tag */}
              <div className="modal" id="my_modal_7">
                <div className="modal-box bg-[#07100B] text-white">
                  <p className="py-4">
                    ...
                    sizing, please feel free to contact our customer support
                    team at [Customer Support Email] or [Customer Support Phone
                    Number]. We want you to have a fantastic shopping experience
                    with Fromdtrip, and the right size is the first step to
                    achieving that.
                  </p>
                  <div className="modal-action">
                    <a href="#footer" className="ui-btn">
                      <span>
                        close
                      </span>
                    </a>
              ...
              <div className="modal" id="my_modal_8">
                <div className="modal-box bg-[#07100B] text-white">
                  <p className="py-4">
                    At Fromdtrip, we are committed to providing you with a
                    seamless shopping experience, including reliable and
                    efficient shipping services. Below, you&apos;ll find
                    important information about our shipping policies. <br />{" "}
                    <br />
                    1. Shipping Destinations: <br /> <br />
                    We are proud to offer shipping services to customers in
                    Puerto Rico and select international destinations. <br />{" "}
                    <br />
                    2. Processing Time: <br /> <br />
                    Orders are typically processed within 1-2 business days
                    after payment confirmation. Please note that processing
                    times may vary during busy seasons and promotional periods.{" "}
                    <br /> <br />
                    3. Shipping Methods: <br /> <br />
                    We offer various shipping options to suit your needs,
                    including standard and expedited shipping. The available
                    shipping methods will be displayed during the checkout
                    process. <br /> <br />
                    4. Shipping Costs: <br /> <br />
                    Shipping costs will be calculated based on your location,
                    the selected shipping method, and the weight/size of your
                    items. You can view the shipping costs during the checkout
                    process. <br /> <br />
                    5. Estimated Delivery Times: <br /> <br />
                    Delivery times will depend on your location and the chosen
                    shipping method. Typically, deliveries within Puerto Rico
                    will take 2-5 business days, while international deliveries
                    may take longer. <br /> <br />
                    6. Order Tracking: <br /> <br />
                    We provide order tracking services to help you stay updated
                    on the status of your shipment. You will receive a tracking
                    number via email once your order has been dispatched. <br />{" "}
                    <br />
                    7. Customs and Import Duties (For International Shipments):{" "}
                    <br /> <br />
                    Please note that for international orders, customs and
                    import duties may apply. These fees are the responsibility
                    of the recipient and are not included in the product or
                    shipping costs. <br /> <br />
                    8. Customer Support: <br /> <br />
                    Our customer support team is here to assist you with any
                    shipping-related inquiries or concerns. Feel free to reach
                    out to us at [Customer Support Email] or [Customer Support
                    Phone Number]. <br /> <br />
                    9. Returns and Refunds: <br /> <br />
                    For information on returns and refunds, please refer to our
                    [Return Policy] on our website. <br /> <br />
                    10. Additional Information: <br /> <br />
                    For more details on our shipping policies, please visit our
                    [Shipping Policy] page on our website. <br /> <br />
                    Thank you for choosing Fromdtrip. We look forward to serving
                    you and ensuring a smooth and timely delivery of your
                    orders. <br /> <br />
          ...
          <div className="grid gap-10">
            <div className="h-12">
              <span className="text-[20px] font-extrabold">About us</span>
            </div>
            <div className="grid gap-5">
              ...
              <div className="modal" id="my_modal_9">
                <div className="modal-box bg-[#07100B] text-white">
                  <p>
                    Our Values and Commitment to the Boricuan Spirit <br />{" "}
                    <br />
                    At Fromdtrip, we&apos;re more than just a clothing brand; we
                    are the embodiment of the Boricuan spirit through design and
                    embroidery. We are deeply committed to celebrating the
                    vibrant and resilient culture of Puerto Rico, and we strive
                    to embody these core values in everything we do: <br />{" "}
                    <br />
                    1. Artistry and Craftsmanship: <br /> <br />
                    We are passionate about the art of design and embroidery.
                    Each piece we create is a work of art, meticulously crafted
                    to capture the essence of Puerto Rico&apos;s culture and
                    spirit. <br /> <br />
                    2. Authenticity and Tradition: <br /> <br />
                    We draw inspiration from the rich traditions and history of
                    Puerto Rico, infusing every design with the island&apos;s
                    unique heritage. We stay true to our roots and celebrate the
                    authenticity of Boricuan artistry. <br /> <br />
                    3. Community Connection: <br /> <br />
                    The Boricuan spirit is deeply rooted in community. We aim to
                    connect with the Puerto Rican community, both on the island
                    and in the diaspora, through our designs and the stories
                    they tell. <br /> <br />
                    4. Quality and Durability: <br /> <br />
                    We take pride in the quality and durability of our products.
                    Every embroidered detail is a testament to our commitment to
                    offering clothing that lasts and continues to inspire.{" "}
                    <br /> <br />
                    5. Sustainability and Responsibility: <br /> <br />
                    Our dedication to sustainability involves responsible
                    sourcing of materials and eco-friendly production methods.
                    We are mindful of our environmental impact and strive to
                    protect Puerto Rico&apos;s natural beauty. <br /> <br />
                    6. Inclusivity and Diversity: <br /> <br />
                    Puerto Rico is a diverse and welcoming place, and we
                    celebrate that diversity by offering designs that resonate
                    with everyone, regardless of their background, age, or
                    gender. <br /> <br />
                    7. Empowerment Through Style: <br /> <br />
                    We want our customers to feel empowered when they wear our
                    designs. Our clothing is an expression of Boricuan identity
                    and a source of pride for those who celebrate Puerto Rico.{" "}
                    <br /> <br />
                    8. Celebration of Culture: <br /> <br />
                    Life in Puerto Rico is a constant celebration, and we want
                    our designs to capture that spirit. Our embroidered styles
                    reflect the vibrancy, festivities, music, and culture that
                    make Puerto Rico unique. <br /> <br />
                    Fromdtrip is a celebration of Puerto Rico, and together,
                    we&apos;ll continue to stitch the fabric of this beautiful
                    culture with every design we create.
                  </p>
                  <div className="modal-action">
                    <a href="#footer" className="ui-btn">
                      <span>
              ...
              <div className="modal" id="my_modal_10">
                <div className="modal-box bg-[#07100B] text-white">
                  <p>
                    Contact Us <br /> <br />
                    At Fromdtrip, we value your feedback, questions, and the
                    opportunity to connect with our community. Our dedicated
                    team is here to assist you in any way we can. Whether you
                    have inquiries about our products, need assistance with an
                    order, or simply want to share your thoughts, we&apos;re
                    ready to listen and support you. <br /> <br />
                    How to Reach Us: <br /> <br />
                    Customer Support Email: from.the.trip@gmail.com Customer
                    Support Phone Number: 939-265-0722 <br /> <br />
                    {/* Our Address: <br/> <br/>
                      [Your Physical Address, if applicable] <br/> <br/> */}
                    Social Media: <br /> <br />
                    Stay connected with us on our social media platforms, where
                    you can get the latest updates on our designs, promotions,
                    and engage with our community of Boricuan spirit
                    enthusiasts. <br /> <br />
                    ...
                    <a href="https://www.tiktok.com/@fromdtrip">TikTok</a>{" "}
                    <br /> <br />
                    Fromdtrip is not just a brand; it&apos;s a celebration of
                    Puerto Rico, its culture, and its people. Your thoughts and
                    experiences matter to us, and we are eager to hear from you.
                    Whether you have a question, feedback, or simply want to
                    chat about all things Boricua, please don&apos;t hesitate to
                    reach out. We look forward to connecting with you. Thank you
                    for being a part of our journey, and we can&apos;t wait to
                    make your Fromdtrip experience a memorable one. Safe travels
                    and happy shopping!
                  </p>
                  <div className="modal-action">
                    <a href="#footer" className="ui-btn">
