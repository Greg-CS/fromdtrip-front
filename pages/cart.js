...
export default function CartPage({ newProducts, CategoryProp }) {
  ...
  const handleSelectChange = (propName, selectedValue) => {
    // Update the selected value for the specific property in state
  ...
  useEffect(() => {
    ...
    setCategoryExamples(categories);
                        ...
                        <tr key={product._id} className='grid grid-cols-1 lg:grid-cols-4 gap-10 items-center border-b-2 border-b-black'>
                          ...
                          <td className="grid mt-10">
                            <div className='justify-self-center'>
                              <img src={product.images} alt={product.title} className='rounded-full border-2 w-40 border-black' />
                            </div>
