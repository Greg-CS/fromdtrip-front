  ...
  return (
    <>
      {isSuccess ?
        ...
        :
        <>
          <div className="grid grid-cols-1 gap-4 pt-4 pb-5 bg-white md:grid-cols-2">
            {/* Cart details */}
            <div className="p-6 mx-5 text-black border-2 border-black rounded-xl">
              ...
              {products?.length > 0 && (
                <Table>
                  <thead>
                    <tr className='hidden grid-cols-4 gap-10 lg:grid'>
                      <th>Product</th>
                      <th>Quantity</th>
                      <th>Price</th>
                  ...
                  <tbody>
                    {products.map((product) => (
                      <tr key={product._id} className='grid items-center grid-cols-1 gap-10 border-b-2 lg:grid-cols-4 border-b-black'>
                        {/* Display product details */}
                        <td className="grid mt-10">
                          <div className='justify-self-center'>
                            <img src={product.images[0]} alt={product.title} className='w-40 border-2 border-black rounded-full' />
                          </div>
