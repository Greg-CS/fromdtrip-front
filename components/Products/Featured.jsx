...
export const Featured = ({ product }) => {
  ...
  return (
      <section className="bg-white">
        <div className="grid md:flex px-36 min-h-screen items-center">
          ...
          <div className="flex gap-5">
            <button className="flex gap-3 btn bg-white text-black font-bold border-black border-2" onClick={addFeaturedToCart}>
